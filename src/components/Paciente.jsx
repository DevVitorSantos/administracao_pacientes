...
function Paciente({paciente, setPaciente, eliminarPaciente}) {
  const { nombre, proprietario, email, fecha, sintomas, id} = paciente

  const handleEliminar = () => {
    const resposta = confirm('deseja eliminar este paciente?')
  ...
  return (
    <div className="mx-5 my-7 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold mb-3 text-gray-700"> Proprietário: {''}
